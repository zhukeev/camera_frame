...
class _CameraViewState extends State<CameraView> {
  ...
  Future _startLiveFeed() async {
    ...
    _controller?.initialize().then((_) {
      ...
      _controller?.startFrameStream(_processCameraFrameImage).then((value) {
  ...
  Future _stopLiveFeed() async {
    await _controller?.stopFrameStream();
  ...
  void _processCameraImage(CameraImageData image) {
  ...
  void _processCameraFrameImage(CameraImageData image) {
    final inputImage = _inputImageFromCameraImage(image);
    if (inputImage == null) return;
    widget.onFrame(inputImage);
  }

  InputImage? _inputImageFromCameraImage(CameraImageData image) {
